...
7. rekuiper's `peak_rss_mb` rises on w1/w3 at high rates (up to 275 MiB) because it includes page cache
   from writing large sink files; its anonymous memory stayed under 15 MiB. Compare engines by
   `peak_anon_mb`.
