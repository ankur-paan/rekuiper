...
> **Archived 0.425 comparison.** This page preserves the original published
> four-engine 30-second rate ladder and its method. The current bounded
> sustained benchmark is [`README.md`](README.md), with detailed results in
